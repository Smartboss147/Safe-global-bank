        ...
        <form onSubmit={handleLoginSubmit} className="space-y-5">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full p-3.5 bg-white border border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-[0.98] flex items-center justify-center gap-3 shadow-sm disabled:opacity-70"
              onClick={async () => {
                setError('');
            ...
            <button
              type="button"
              className="w-full p-3.5 bg-white border border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-sm"
